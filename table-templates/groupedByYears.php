<div class="tab-container">
    <button class="tab tab-active" id="table-tab" onclick="showTable('years')">Таблица</button>
    <button class="tab" id="chart-tab" onclick="showChart('years')">Графика</button>
</div>
...
<div class="chart-container" id="years" hidden></div>

<div class="tab-container">
    <button class="tab tab-active" id="table-tab" onclick="showTable('groups')">Таблица</button>
    <button class="tab" id="chart-tab" onclick="showChart('groups')">Графика</button>
</div>
...
<div class="chart-container" id="groups" hidden></div>
